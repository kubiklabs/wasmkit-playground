...
function Execute(contractName: any) {
  ...
  const className = (contract=="counter")? "CounterContract" : "StakingContractContract";
  const interfaceName = (contract=="counter")? "CounterInterface" : "StakingContractInterface";
...
else {if(!interfaceStructure?.properties || interfaceStructure.properties.length === 0)
{}
else{
      propertiesJsx = (
      <div>
...
function handleSelect(event: React.ChangeEvent<HTMLSelectElement>) {
  ...
  return ( 
    <div className='execute-page'>
      ...
      <select id="menu" className='dropdown-menu' value={selectedItem} onChange={handleSelect}>
